...
export default function ProductDetails() {
  ...
  return (
    ...
    <section>
       ...
       <div className="grid grid-cols-12 gap-8" key={productDetails.id}>
           ...
           <div className="col-span-12 md:col-span-5 ">
               <div>
                   <h2 className="text-gray-700">{productDetails.title}</h2>
               ...
               <div className="mt-5 flex items-center justify-between">
                   ...
                   <span><i className="text-yellow-600 mr-2 fa-solid fa-star"></i>{productDetails.ratingsAverage}</span>
               </div>
               <button
               onClick ={()=>{
                   addToCart(id)
               }} 
               className="w-full mt-5 p-2 rounded-md text-white bg-primary">Add To Cart</button>
           </div>
       </div>
   ...
   <section>
    ...
    <Swiper loop={true} autoplay={true} slidesPerView={6} spaceBetween={10}>
    {related.map((re)=> 
